...
import com.interviewbit.tree.BinSearchTree.Node;
...
class BinSearchTree {
	...
	/*
	 * public Node binSearch(Node trav, int key) { if(trav == null) return null;
	 * if(key == trav.data) return trav; if(key < trav.data) return
	 * binSearch(trav.left, key); else // if(key >= trav.data) return
	 * binSearch(trav.right, key); } public Node binSearch(int key) { return
	 * binSearch(root, key); }
	 */
